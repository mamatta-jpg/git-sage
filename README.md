...
[![CI](https://github.com/mamatta-jpg/git-sage/actions/workflows/ci.yml/badge.svg)](https://github.com/mamatta-jpg/git-sage/actions/workflows/ci.yml)
[![PyPI](https://img.shields.io/pypi/v/git-sage-mm)](https://pypi.org/project/git-sage-mm/)
[![Python](https://img.shields.io/pypi/pyversions/git-sage-mm)](https://pypi.org/project/git-sage-mm/)
